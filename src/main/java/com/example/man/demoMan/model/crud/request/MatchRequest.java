...
public class MatchRequest {
	...
	/**
	 * @return the matNomComercio
	 */
	public String getMatNomComercio() {
		return matNomComercio;
	}
	/**
	 * @param matNomComercio the matNomComercio to set
	 */
	...
	/**
	 * @param matRuc the matRuc to set
	 */
	public void setMatRuc(String matRuc) {
		this.matRuc = matRuc;
	}
	/**
	 * @return the matReprLeg
	 */
	public String getMatReprLeg() {
		return matReprLeg;
	}
	/**
	 * @param matReprLeg the matReprLeg to set
	 */
